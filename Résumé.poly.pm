...
◊section["Skills & Abilities"]{
  ...
  ◊par[#:roles '("Design Thinking/User Experience")]{
    Customer Development Interviews and Design Thinking (at rootlinks, zelium, humane.tools) ◊br{}
...
◊section["Work Experience"]{
  ...
  ◊par[#:org "AI Safety Tübingen" #:url "https://aisafetytuebingen.com" #:area "AI Safety Fellowship" #:roles '("Project Lead: AI Safety Fellowship") #:date "02/2026-Present" #:loc "Tübingen" #:topics "Operations" #:show-tops? #t]{
  ...
  ◊par[#:org "Active Group GmbH" #:url "https://www.active-group.de" #:area "Software Architecture" #:roles '("Software Architect") #:date "05/2024-Present" #:loc "Tübingen/Remote" #:topics "Software Architecture, TypeScript, Clojure, ClojureScript, Docker, Nix, SolidJS, TailwindCSS"]{
  ...
  ◊par[#:org "zelium.io" #:url "https://zelium.io" #:area "Startup" #:roles '("Startup Founder") #:date "09/2023-05/2024" #:loc "Tübingen" #:topics "Systems Practice, Design Thinking, Elixir, Phoenix LiveView, Tailwind CSS, CodeMirror, Nix"]{
    ...
    ◊ul{
      ◊li{Applied ◊l["https://oecd-opsi.org/toolkits/systems-practice-workbook/"]{Systems Practice} to the problem of digital collaboration. Identified a gap: A tool that starts simple, makes project sharing easy, but lets you scale up to scheduling, meeting protocols and more.}
      ◊li{Conducted ~10 Customer Development Interviews and built low-fidelity prototypes, prioritized features, shipped an MVP.}
    }
  }
  ◊par[#:org "Hacker School gGmbH" #:url "https://hacker-school.de" #:area "NGO: Education" #:roles '("Working Student") #:date "02/2021-03/2023" #:loc "Hamburg/Remote" #:topics "Sociocracy, Racket, Teaching"]{
    Created a course website and courses with ◊l["https://pollenpub.com"]{Pollen}. Both used by thousands of students.
  ...
  ◊par[#:org "Deutsche SchülerAkademie" #:url "https://www.deutsche-schuelerakademien.de" #:area "" #:roles '("Course Instructor") #:date "17 days each | 07/2025 + 07/2022" #:loc "Roßleben" #:topics "Science, Teaching, Learning" #:show-tops? #t]{
...
◊section["Education"]{
  ...
  ◊par[#:org "Leibniz Kolleg" #:url "https://uni-tuebingen.de/einrichtungen/verwaltung/stabsstellen/leibniz-kolleg/das-leibniz-kolleg/" #:area "" #:roles '("Studium generale et sociale") #:date "10/2018-07/2019" #:loc "Tübingen" #:topics ""]{
